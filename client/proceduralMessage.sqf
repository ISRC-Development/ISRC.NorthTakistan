...
{ 
   [ 
       ["June 7th, 2027","<t align = 'center' shadow = '1' size = '0.7'>%1</t><br/>"], 
       ["Laguna","<t align = 'center' shadow = '1' size = '1.0'>%1</t><br/>"],
       ["Northern Colombia","<t align = 'center' shadow = '1' size = '0.7'>%1</t><br/>"]
   ] spawn Bis_printText; 
}; 